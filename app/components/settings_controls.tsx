...
// Rendered twice by Nav — once inline (desktop, always visible) and once
// inside the popover panel (mobile, opened on demand). Same buttons, same
// state, so the two presentations can never drift apart.
    ...
    <>
      <div className="settings_group">
        <span className="settings_label">
          <span className="en_inline">Language</span>
          <span className="tr_inline">Dil</span>
        </span>
      ...
      <div className="settings_group">
        <span className="settings_label">
          <span className="en_inline">Theme</span>
          <span className="tr_inline">Tema</span>
        </span>
        <div className="settings_buttons">
          <button
            type="button"
